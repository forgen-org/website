...
<Callout type="warning" emoji="⚠️">
  Typescript is not yet supported in Forgen Architecture. We are waiting to stabilize the Rust implementation first and will work on adding support and examples for TypeScript later.
</Callout>
