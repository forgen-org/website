...
<Callout emoji="⚠️" type="warning">
  The publish method is part of service `EventBus`. The `subscribe` method should maybe be part of a client since it is a reaction to some sort of input. This can lead to complex logic.
</Callout>
